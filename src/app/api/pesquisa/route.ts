...
async function getGeminiAnalysis(query: string, image?: string): Promise<GeminiResponse> {
    ...
    2. Identificar EXATAMENTE UMA peça específica aplicável ao carro, ano e motor. NÃO crie listas de peças variadas nem retorne explicações genéricas. O FOCO É APENAS NA PEÇA CORRETA.
    ...
    REGRAS DE FORMATO JSON - VOCÊ DEVE RETORNAR APENAS ESTE JSON VÁLIDO:
    {
      "identificacao_tecnica": {
        ...
        "breve_explicativo": "Uma frase simples explicando o que é a peça identificada e sua função",
