...
import { Search, LayoutDashboard, Activity, CheckCircle2, ImagePlus, Camera, X, LogIn, LogOut, User, Headset } from 'lucide-react';
    ...
    try {
      ...
      fetch('/api/logger', {
        ...
        body: JSON.stringify({
          ...
          context: { origin: 'frontend_search_submit', query },
          user_id: user?.id
        })
      }).catch(() => { });
