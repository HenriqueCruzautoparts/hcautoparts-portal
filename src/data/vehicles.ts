export const vehicleData: Record<string, Record<string, Record<string, string[]>>> = {
  "Audi": {
    ...
    "A3": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.4 TFSI", "1.8 TFSI", "2.0 TFSI (EA888)", "1.6", "1.8", "1.8T"]])),
    "A4": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.8 TFSI", "2.0 TFSI", "3.2 FSI", "1.8T", "2.4", "2.8 V6", "3.0 V6"]])),
    "A5": Object.fromEntries(Array.from({ length: 17 }, (_, i) => 2024 - i).map(y => [y.toString(), ["2.0 TFSI", "3.2 FSI", "1.8 TFSI"]])),
    "A6": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["2.0 TFSI", "2.4", "2.8 FSI", "3.0 TFSI", "4.2 V8"]])),
    ...
    "TT": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.8T", "2.0 TFSI", "3.2 V6", "2.5 TFSI"]]))
  },
  "BMW": {
    "Série 1 (116i, 118i, 120i, 125i, 130i, M135i)": Object.fromEntries(Array.from({ length: 20 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.5 TwinPower Turbo", "1.6 TwinPower Turbo", "2.0 16V", "2.0 TwinPower Turbo", "3.0 L6"]])),
    "Série 2 (220i, M235i, M2)": Object.fromEntries(Array.from({ length: 11 }, (_, i) => 2024 - i).map(y => [y.toString(), ["2.0 TwinPower Turbo", "3.0 L6 TwinPower Turbo"]])),
    "Série 3 (318i, 320i, 325i, 328i, 330i, 335i)": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["2.0 TwinPower Turbo (B48)", "2.0 TwinPower Turbo (N20)", "2.0 16V", "2.5 L6", "3.0 L6", "3.0 L6 Biturbo"]])),
    "Série 4 (420i, 428i, 430i)": Object.fromEntries(Array.from({ length: 11 }, (_, i) => 2024 - i).map(y => [y.toString(), ["2.0 TwinPower Turbo", "3.0 L6 TwinPower Turbo"]])),
    "Série 5 (528i, 530i, 540i, 550i)": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["2.0 TwinPower Turbo", "3.0 L6", "4.4 V8 Biturbo", "4.8 V8"]])),
  ...
  "Volkswagen": {
    ...
    "Fox": Object.fromEntries(Array.from({ length: 19 }, (_, i) => 2021 - i).map(y => [y.toString(), ["1.0 8V", "1.0 12V", "1.6 8V", "1.6 16V MSI"]])),
    ...
    "Golf": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.0 TSI", "1.4 TSI", "1.6 8V", "1.8T", "2.0 8V", "2.0 TSI (GTI)"]])),
    "Jetta": Object.fromEntries(Array.from({ length: 19 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.4 TSI", "2.0 8V Flex", "2.0 TSI", "2.5 20V"]])),
    ...
    "Passat": Object.fromEntries(Array.from({ length: 21 }, (_, i) => 2020 - i).map(y => [y.toString(), ["1.8T", "2.0", "2.0 TSI", "2.8 V6", "3.2 V6 FSI"]])),
    "Polo": Object.fromEntries(Array.from({ length: 23 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.0 12V MPI", "1.0 TSI", "1.4 TSI (GTS)", "1.6 8V", "1.6 16V MSI", "2.0 8V"]])),
    ...
    "Vistrus": Object.fromEntries(Array.from({ length: 7 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.0 TSI", "1.4 TSI (GTS)", "1.6 16V MSI"]])),
  ...
  "Chevrolet": {
    ...
    "Astra": Object.fromEntries(Array.from({ length: 12 }, (_, i) => 2011 - i).map(y => [y.toString(), ["1.8 8V", "2.0 8V", "2.0 16V"]])),
    ...
    "Celta": Object.fromEntries(Array.from({ length: 16 }, (_, i) => 2015 - i).map(y => [y.toString(), ["1.0 VHC", "1.0 VHC-E", "1.4"]])),
    "Classic": Object.fromEntries(Array.from({ length: 13 }, (_, i) => 2016 - i).map(y => [y.toString(), ["1.0 VHC", "1.0 VHC-E"]])),
    "Cobalt": Object.fromEntries(Array.from({ length: 9 }, (_, i) => 2020 - i).map(y => [y.toString(), ["1.4 Econo.Flex", "1.8 Econo.Flex"]])),
    "Corsa": Object.fromEntries(Array.from({ length: 13 }, (_, i) => 2012 - i).map(y => [y.toString(), ["1.0 8V", "1.0 16V", "1.4 Econo.Flex", "1.8 8V"]])),
    "Cruze": Object.fromEntries(Array.from({ length: 14 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.4 Turbo Flex", "1.8 Ecotec Flex"]])),
  ...
  "Honda": {
    ...
    "Civic": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["1.5 Turbo", "1.7 16V VTEC", "1.8 16V i-VTEC", "2.0 16V i-VTEC", "2.0 16V Hybrid"]])),
    "CR-V": Object.fromEntries(Array.from({ length: 25 }, (_, i) => 2024 - i).map(y => [y.toString(), ["2.0 16V", "2.4 16V", "1.5 Turbo"]])),
    "Fit": Object.fromEntries(Array.from({ length: 19 }, (_, i) => 2021 - i).map(y => [y.toString(), ["1.4 8V", "1.4 16V i-VTEC", "1.5 16V VTEC", "1.5 16V i-VTEC"]])),
  ...
  "Ford": {
    ...
    "Fiesta": Object.fromEntries(Array.from({ length: 20 }, (_, i) => 2019 - i).map(y => [y.toString(), ["1.0 Zetec Rocam", "1.5 Sigma", "1.6 Sigma", "1.6 Zetec Rocam"]])),
    "Focus": Object.fromEntries(Array.from({ length: 19 }, (_, i) => 2019 - i).map(y => [y.toString(), ["1.6 Sigma", "1.6 Zetec Rocam", "1.8 16V Zetec", "2.0 16V Zetec", "2.0 Duratec", "2.0 Direct Flex"]])),
    "Fusion": Object.fromEntries(Array.from({ length: 14 }, (_, i) => 2019 - i).map(y => [y.toString(), ["2.0 EcoBoost", "2.0 Hybrid", "2.3 16V", "2.5 16V Flex", "3.0 V6"]])),
    "Ka": Object.fromEntries(Array.from({ length: 22 }, (_, i) => 2021 - i).map(y => [y.toString(), ["1.0 Zetec Rocam", "1.0 Ti-VCT", "1.5 Sigma", "1.5 Dragon", "1.6 Zetec Rocam"]])),
    "Ka Sedan": Object.fromEntries(Array.from({ length: 7 }, (_, i) => 2021 - i).map(y => [y.toString(), ["1.0 Ti-VCT", "1.5 Sigma", "1.5 Dragon"]])),
    "Mustang": Object.fromEntries(Array.from({ length: 7 }, (_, i) => 2024 - i).map(y => [y.toString(), ["5.0 V8 Coyote"]])),
